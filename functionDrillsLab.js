...
//CODE HERE
const compareNums = (num1, num2) => num1 > num2 ? num1 : num2 > num1 ? num2 : num1 === num2 ? `They are equal` : ""
...
// console.log('arrow')
 //console.log('declaration') This is correct 
...
const exclaimTwo = str => {
 ...
 //console.log('arrow') This is correct
...
//CODE HERE
const bestMovie = (str) => {
  console.log(`${str} is the best movie ever!`);
}
//bestMovie('The Room');
////////////////// PROBLEM 15 ////////////////////
...
//CODE HERE
function theEliminator(arr, arr) {
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] === loser) {
      arr[i].splice(loser);
    }
...
const result = theEliminator(contestants, loser);
//console.log(result)
////////////////// PROBLEM 17 ////////////////////
...
const emailCheck = function(email) {
  ...
  if (emailAddress.includes('@')) {
    ...
    console.log('must provide a vlaid email address');
  }
}
//emailCheck('philmodel.101@gmail.com');
////////////////// PROBLEM 19 ////////////////////
/*
...
//CODE HERE
function frogPurchaser(num) {
  let chocolateFrogs = 3;
  let totalFrogs = num / chocolateFrogs;
  console.log(totalFrogs);
}
//frogPurchaser(26);
////////////////// PROBLEM 20 ////////////////////Ask about this
/*
  You might have noticed a slight bug in the previous problem. If you were to pass in 4 gold, the function would return to you 1.3333... However, you can't really go to a store and by 1.333 products. You would just be able to purchase 1 product. Re-write the function you used in the previous problem (give it the same name, just add a 2 to the end of it) that fixes this bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/

//CODE HERE
function frogPurchaser2(num) {
  let chocolateFrogs2 = 3;
  let totalFrogs2 = Math.floor(num / chocolateFrogs2);
